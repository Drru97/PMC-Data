...
{
    /// <summary>
    /// Class that describes 2D position
    /// </summary>
    /// <typeparam name="T">Type of point</typeparam>
    public class Position2D<T> : Position, IEnumerable, IEnumerator where T : struct
    {
        /// <summary>
        /// List of the points in the position
        /// </summary>
        public List<Point2D<T>> Points { get; set; }
        /// <summary>
        ...
        public void AddPoint(params Point2D<T>[] point)
        {
