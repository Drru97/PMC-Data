...
{
    /// <summary>
    /// Class that describes 1D position
    /// </summary>
    /// <typeparam name="T">Type of point</typeparam>
    public class Position1D<T> : Position, IEnumerable, IEnumerator where T : struct
    {
        /// <summary>
        /// List of points in the position
        /// </summary>
        public List<Point1D<T>> Points { get; set; }
        /// <summary>
        ...
        public void AddPoint(params Point1D<T>[] point)
        {
